...
var (
	...
	azureADClientID  = os.Getenv("TF_AZURE_SP_ALTERNATIVE_APP_ID")
...
func TestScaler(t *testing.T) {
	...
	require.NotEmpty(t, azureADClientID, "TF_AZURE_SP_ALTERNATIVE_APP_ID env variable is required for service bus tests")
